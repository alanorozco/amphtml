...
export class VideoManagerV1 {
  ...
  unregister(video) {
    const {element} = video;
    dev().info(TAG, 'Called `unregister`, but `VideoManagerV1` doesn\'t ' +
      'know how to do that. %s', element);
  }
 ...
 */
export function installVideoManagerV1ForDoc(nodeOrDoc) {
  registerServiceBuilderForDoc(nodeOrDoc, 'video-manager', VideoManagerV1);
}
